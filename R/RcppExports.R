...
#' 
#' @export 
tsmvr_solve <- function(X, Y, s1, s2, BType = "gd", OmegaType = "gd", eta1 = 0.001, eta2 = 0.001, epsilon = 1e-4, maxiter = 1000L, skip = 10L, quiet = FALSE) {
    .Call('_tsmvr_tsmvr_solve', PACKAGE = 'tsmvr', X, Y, s1, s2, BType, OmegaType, eta1, eta2, epsilon, maxiter, skip, quiet)
}
