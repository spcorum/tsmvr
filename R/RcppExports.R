...
htHelper <- function(X, s) {
    .Call(`_tsmvr_htHelper`, X, s)
}
...
gdB <- function(B, Omega, S, H, n, eta) {
    .Call(`_tsmvr_gdB`, B, Omega, S, H, n, eta)
}

gdOmega <- function(B, Omega, X, Y, eta) {
    .Call(`_tsmvr_gdOmega`, B, Omega, X, Y, eta)
}

updateB <- function(B, Omega, X, Y, S, H, type, s, eta = 0.01, rho = 0.5, beta = 0.5) {
    .Call(`_tsmvr_updateB`, B, Omega, X, Y, S, H, type, s, eta, rho, beta)
}

updateOmega <- function(B, Omega, X, Y, type, s, eta = 0.01, rho = 0.5, beta = 0.5) {
    .Call(`_tsmvr_updateOmega`, B, Omega, X, Y, type, s, eta, rho, beta)
}
