...
#' @param quiet whether or not to print updates to screen (bool)
#' @param suppress_warnings whether or not to suppress warnings (bool)
#'
...
#'
#' @export
tsmvr_solve <- function(X, Y, s1, s2, B_type = "gd", Omega_type = "gd", eta1 = 0.001, eta2 = 0.001, epsilon = 1e-4, max_iter = 1000L, skip = 10L, quiet = FALSE, suppress_warnings = FALSE) {
    .Call(`_tsmvr_tsmvr_solve`, X, Y, s1, s2, B_type, Omega_type, eta1, eta2, epsilon, max_iter, skip, quiet, suppress_warnings)
}
