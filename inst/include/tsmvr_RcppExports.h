...
namespace tsmvr {
    ...
    inline List tsmvr_solve(const arma::mat& X, const arma::mat& Y, const int& s1, const int& s2, const String& B_type = "gd", const String& Omega_type = "gd", const double& eta1 = 0.001, const double& eta2 = 0.001, const double& epsilon = 1e-4, const int& max_iter = 1000, const int& skip = 10, const bool& quiet = false) {
